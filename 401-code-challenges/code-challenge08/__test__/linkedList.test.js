...
describe("LinkedList", () => {
  ...
  it("kthFromEnd() Where k is greater than the length of the linked list", () => {
    ...
    newList.append(8);
    newList.append(2);
    expect(newList.kthFromEnd(5)).toEqual("there is no results 3aaaa");
  });
  it("kthFromEnd() Where k is not a positive integer", () => {
    ...
    newList.append(8);
    newList.append(2);
    expect(newList.kthFromEnd(-1)).toEqual("there is no results for searching less than zero");
  });
  it("kthFromEnd() Where k and the length of the list are the same", () => {
    ...
    newList.append(8);
    newList.append(2);
    expect(newList.kthFromEnd(4)).toEqual("there is no results 3aaaa");
  });
